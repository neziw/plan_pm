...
class AppColor {
  ...
  //     Colors.black; // Czarny ma lepszy kontrast na tym jaśniejszym niebieskim
  // static Color onPrimaryVariant = Colors.black.withAlpha(
  //   180,
  // ); // Tutaj wariant pasuje

  // // Utility
  // static Color outline = Colors.white.withAlpha(30); // Subt
}
